...
*/
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x2, 0x00); // DC = DC Low
    GPIOPinWrite(GPIOA2_BASE, 0x40, 0x00); // CS = CS Low
    MAP_SPICSEnable(GSPI_BASE);

    MAP_SPIDataPut(GSPI_BASE,c);

    MAP_SPIDataGet(GSPI_BASE,&cDummy);

    GPIOPinWrite(GPIOA2_BASE, 0x40, 0xFF); // CS = CS High
    

    MAP_SPICSDisable(GSPI_BASE);

    // GPIOPinWrite(GPIOA1_BASE, 0x40, 0x40); //DC = DC HIGH
...
void writeData(unsigned char c) {
    ...
    */
    ...
    GPIOPinWrite(GPIOA1_BASE, 0x2, 0xFF); // DC = DC High
    GPIOPinWrite(GPIOA2_BASE, 0x40, 0x00); // CS = CS Low
    MAP_SPICSEnable(GSPI_BASE);
    ...
    MAP_SPICSDisable(GSPI_BASE);
    // GPIOPinWrite(GPIOA1_BASE, 0x40, 0); // DC = DC Low
